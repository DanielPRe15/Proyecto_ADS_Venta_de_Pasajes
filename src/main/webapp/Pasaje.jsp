    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="mt-5 , container">
 			...
 			<form id="frmDocente" action="ServletPasaje?tipo=REGISTRAR" method="post">
			  ...
			  <div class="form-group">
			    <label for="dni" class="form-label">Fecha de Ida</label>
			    <input type="date" class="form-control" name="ida">
			  </div>
			  
			  <div class="form-group">
			    <label for="numero" class="form-label">Fecha de Retorno</label>
